class Rope
  {
    ...
    {//nlink e o numeros de links
      //e o pointAe a conecsao das cordas
      this.nlink = nlink
  const group = Body.nextGroup(true);
  //Composites.stack cria corpos retangulares e armazena dentro da variavel rects
  ...
  World.add(engine.world, this.body);
      ...
      //Constraint.create conecta as coisas
